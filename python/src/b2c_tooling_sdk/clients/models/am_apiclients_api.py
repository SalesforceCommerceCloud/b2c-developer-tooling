...
class APIClientCreate(BaseModel):
    ...
    name: str = Field(
        ..., description="Name of the API client.", max_length=200, min_length=1
    )
    description: str | None = Field(
        None, description="Description of the API client.", max_length=256, min_length=0
    )
    ...
    redirectUrls: list[str] | None = Field(
        None, description="List of allowed redirect URLs for OAuth flows."
    )
    scopes: list[str] | None = Field(
        None, description="OAuth scopes available to this API client."
    )
    defaultScopes: list[str] | None = Field(
        None, description="Default OAuth scopes granted to this API client."
    )
    ...
    versionControl: list[str] | None = Field(
        None, description="Version control system identifiers."
    )
    roles: list[str] | None = Field(
        None, description="List of IDs of the roles this API client possesses."
    )
    ...
    tokenEndpointAuthMethod: TokenEndpointAuthMethod | None = Field(
        None, description="Enforced for OIDC flows."
    )
...
class APIClientUpdate(BaseModel):
    ...
    name: str | None = Field(
        None, description="Name of the API client.", max_length=200, min_length=1
    )
    description: str | None = Field(
        None, description="Description of the API client.", max_length=256, min_length=0
    )
    ...
    organizations: list[str] | None = Field(
        None, description="List of organization IDs this API client belongs to."
    )
    active: bool | None = Field(
        False,
        description="Indicates whether the API client is active. New API clients are created as inactive (false) by default.",
...
class APIClientRead(BaseModel):
    ...
    lastAuthenticatedDate: date | None = Field(
        None, description="Date of the last successful authentication."
    )
    disabledTimestamp: AwareDatetime | None = Field(
        None, description="Timestamp when the API client was disabled."
    )
    createdAt: AwareDatetime | None = Field(
        None, description="Timestamp when the API client was created."
    )
