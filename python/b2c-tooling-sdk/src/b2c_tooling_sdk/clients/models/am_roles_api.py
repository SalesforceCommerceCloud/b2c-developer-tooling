...
class Role(BaseModel):
    ...
    targetType: TargetType | None = Field(None, description="Type of entity the role can be assigned to.")
    twoFAEnabled: bool | None = Field(
        None, description="Indicates if two-factor authentication is required for the role."
    )
...
class FieldError(BaseModel):
    ...
    rejectedValue: dict[str, Any] | None = Field(None, description="The value that was rejected")
