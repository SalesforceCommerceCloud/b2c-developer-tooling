...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const processLambdaResponse = (response: APIGatewayProxyResult, event: APIGatewayProxyEvent): any => {
...
const createLambdaHandler = (app: Express): HandlerFunction => {
  return (event: APIGatewayProxyEvent, context: Context, callback: Callback) => {
