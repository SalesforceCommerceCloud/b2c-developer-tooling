...
- [#702](https://github.com/SalesforceCommerceCloud/b2c-developer-tooling/pull/702) [`ae2b79e`](https://github.com/SalesforceCommerceCloud/b2c-developer-tooling/commit/ae2b79e522125bd515e39ec538bba7ab569179e9) - Script API IntelliSense now resolves cartridge requires that point at legacy `.ds` scripts, and reports them to the language service as JavaScript rather than TypeScript. `.js` still takes precedence when both extensions exist. (Thanks [@clstopher](https://github.com/clstopher)!)
