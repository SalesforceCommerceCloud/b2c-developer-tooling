...
import EcdnFirewallGet from '../../../../src/commands/ecdn/firewall/get.js';
import {createIsolatedConfigHooks, createTestCommand} from '../../../helpers/test-setup.js';

describe('ecdn firewall get', () => {
  ...
  async function createCommand(flags: Record<string, unknown> = {}) {
    return createTestCommand(EcdnFirewallGet, hooks.getConfig(), flags, {});
  }
  ...
  it('returns the rule in JSON mode', async () => {
