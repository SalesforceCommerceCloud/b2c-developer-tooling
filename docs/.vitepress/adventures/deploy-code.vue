<!--
  Deploy cartridge code · Quickstart adventure.

  Page shim: docs/quickstart/deploy-code.md
-->
...
<template>
  <Wizard
    ...
    intro="Code deployment uses WebDAV to upload files. Listing and activating code versions additionally requires OAuth + OCAPI."
  ...
  >
    ...
    >
      ...
      >
        Short-lived sandbox provisioned with <code>b2c sandbox</code>.
      </QChoice>
      <QChoice
        id="primary"
      ...
      >
        A long-running instance with its own hostname and credentials.
      </QChoice>
    </QStep>
    ...
    >
      ...
      >
        Best performance for large uploads. Generate the access key in Business Manager.
      </QChoice>
      <QChoice
        id="oauth"
      ...
      >
        Requires WebDAV Client Permissions configured in BM for your <code>client_id</code>.
      </QChoice>
    </QStep>
    ...
    <QStep
      ...
      :doc="{path: '/guide/authentication', hash: 'ocapi-configuration', label: 'OCAPI Configuration'}"
    >
      <QChoice
        id="yes"
      ...
      >
        Adds an Account Manager API client and an OCAPI Data API entry for <code>/code_versions</code>.
      </QChoice>
      <QChoice
        id="no"
      ...
      >
        Skip OCAPI. You can still upload but will need to activate code versions in BM manually.
      </QChoice>
    </QStep>
    ...
    >
      ...
      >
        Per-project config file with walk-up discovery.
      </QChoice>
      <QChoice
        id="env"
