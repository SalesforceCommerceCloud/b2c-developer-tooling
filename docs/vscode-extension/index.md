...
<!-- TODO(screenshot): activity bar with all three B2C-DX containers expanded -->
...
<!-- TODO(screenshot): sandbox-explorer.png -->
...
<!-- TODO(screenshot): webdav-browser.png -->
...
<!-- TODO(screenshot): script-debugger.png -->
